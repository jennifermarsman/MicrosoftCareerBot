    ...
    public class MessagesController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Post([FromBody]Activity activity)
        {
            if (activity.Type == ActivityTypes.Message)
            {
                ...
                string answer = "Hmmmm, I didn't understand that.  I'm still learning!  You can ask me about job locations, diversity in hiring, benefits, preparing for your interview, and more.  You can also contact a recruiter directly at mlrecruiting@microsoft.com.";

                string token = activity.Text.ToLower().Trim();
                if (token.Equals("hi") || token.Equals("hello"))
                {
                    answer = "Hello!  You can ask me about job locations, diversity in hiring, benefits, preparing for your interview, and more.";
                }
                else
                { 
